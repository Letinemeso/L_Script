...
namespace LScript
{
    ...
    private:
        ...
        unsigned int M_parse_expression(Context& _context, const std::string& _source, unsigned int _offset, unsigned int _max_size = Unlimited_Size) const;
